...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seller.avatar'
        db.add_column('mainpage_seller', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seller.avatar'
        db.delete_column('mainpage_seller', 'avatar')
    ...
    models = {
        ...
        'mainpage.product': {
            ...
            'publish_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 0, 0)'}),
