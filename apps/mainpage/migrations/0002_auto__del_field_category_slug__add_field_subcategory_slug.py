...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('mainpage_category', 'slug')

        # Adding field 'Subcategory.slug'
        db.add_column('mainpage_subcategory', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=80),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Category.slug'
        db.add_column('mainpage_category', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=80),
                      keep_default=False)

        # Deleting field 'Subcategory.slug'
        db.delete_column('mainpage_subcategory', 'slug')
    ...
    models = {
        ...
        'mainpage.subcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '80'})
        }
    }
